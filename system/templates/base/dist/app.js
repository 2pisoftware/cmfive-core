...
/* harmony import */ var _adaptations_dropdown__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./adaptations/dropdown */ "./src/js/adaptations/dropdown.ts");
...
function openModal(url) {
  var modal = new bootstrap__WEBPACK_IMPORTED_MODULE_1__.Modal(document.getElementById('cmfive-modal'));
  fetch(url).then(function (response) {
    return response.text();
  }).then(function (content) {
    jquery__WEBPACK_IMPORTED_MODULE_0__('#cmfive-modal .modal-content').html(content);
    modal.show();
  });
}
...
var THEME_KEY = 'theme';
var app = new vue_property_decorator__WEBPACK_IMPORTED_MODULE_4__.Vue({
  el: '#app',
  data: {
    showSidemenu: false,
  ...
  mounted: function mounted() {
    ...
    _adaptations_dropdown__WEBPACK_IMPORTED_MODULE_3__.DropdownAdaptation.bindDropdownHover();
    var theme = localStorage.getItem(THEME_KEY);
    ...
    document.querySelectorAll('[data-modal-target]').forEach(function (m) {
      m.addEventListener('click', function () {
        return openModal(m.getAttribute('data-modal-target'));
      });
    });
  }
});
