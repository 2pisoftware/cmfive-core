...
var TabAdaptation = function () {
  ...
  TabAdaptation.changeTab = function (hash) {
    ...
    document.querySelectorAll(".tab-body > div").forEach(function (el) {
  ...
  TabAdaptation.bindTabInteractions = function () {
    ...
    if (hash && hash.length > 0) {
      ...
      var target = document.querySelector(".tab-head > a:first");
...
/* harmony import */ var _adaptations_tabs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./adaptations/tabs */ "./src/js/adaptations/tabs.ts");
...
var app = new vue_property_decorator__WEBPACK_IMPORTED_MODULE_2__.Vue({
  el: '#app',
  data: {
    showSidemenu: false
  },
  ...
  mounted: function mounted() {
    _adaptations_tabs__WEBPACK_IMPORTED_MODULE_1__.TabAdaptation.bindTabInteractions();
  }
});
