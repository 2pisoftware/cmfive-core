...
<html class="no-js" lang="en">
    <head>
		...
		CmfiveStyleComponentRegister::registerComponent('foundation-6', new CmfiveStyleComponent(
			"/composer/vendor/zurb/foundation/dist/css/foundation.min.css"
		));

        CmfiveStyleComponentRegister::registerComponent('app', new CmfiveStyleComponent("/system/templates/app.scss"));
    ...
    <body>
		...
		<div class="row-fluid">
            <nav class="top-bar" data-topbar><?php // To make it that you need to click to activate dropdown use  data-options="is_hover: false" ?>
                <ul class="title-area">
                    <li class="name">
