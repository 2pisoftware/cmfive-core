    ...
    var app = new Vue({
        ...
        methods: {
            updateAccountDetails: function() {
                ...
                axios.post("/admin-user/ajax_update_account_details", {
                    id: _this.user.id,
            ...
            updatePassword: function() {
                ...
                axios.post("/admin-user/ajax_update_password", {
                    id: _this.user.id,
            ...
            getMfaQrCode: function() {
                ...
                axios.get("/admin-user/ajax_get_mfa_qr_code", {
                    params: {
                        id: _this.user.id
                    }
                }).then(function(response) {
            ...
            confirmMfaCode: function() {
                ...
                axios.post("/admin-user/ajax_confirm_mfa_code", {
                    id: _this.user.id,
            ...
            disableMfa: function() {
                ...
                axios.post("/admin-user/ajax_disable_mfa", {
                    id: _this.user.id
                }).then(function(response) {
                    if (response.status !== 200) {
