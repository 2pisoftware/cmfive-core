                ...
                var replyForm = $('<div></div>').addClass('comment_section')
                    .append($('<div></div>').addClass('comment_body clearfix')
                        .append($('<div></div>').addClass('medium-1 column')
                            .append($('<img/>').addClass('comment_avatar').attr('src', 'https://www.gravatar.com/avatar/<?php echo md5(strtolower(trim(@AuthService::getInstance($w)->user()->getContact()->email))); ?>?d=identicon')))
