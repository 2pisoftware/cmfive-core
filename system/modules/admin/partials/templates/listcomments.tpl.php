...
if ($w->auth->hasRole('comment')) {
    ...
    echo Html::box("/admin/comment/0/{$object->getDbTablename()}/{$object->id}?redirect_url=" . urlencode($redirect) . "&internal_only=" . (!empty($internal_only) && $internal_only === true ? '1' : '0'), "Add Comment", true);
